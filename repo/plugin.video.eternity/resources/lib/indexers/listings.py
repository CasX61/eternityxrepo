...
class listings:
	def __init__(self):
		...
		self.api_key = '637b0f719c269e9fb609f34f5c35b7e6'
		self.lang = 'de'
		self.list = []
		self.total_pages = 0
		self.query = ''
	...
	def movieGenres(self):
		...
		# Add Anime as special genre (Animation + Japan)
		self.list.append({'name': 'Anime', 'url': 'with_genres=16&with_origin_country=JP&without_genres=99&sort_by=vote_count.desc', 'image': 'genres.png', 'action': 'listings'})
	...
	def tvGenres(self):
		...
		# Add Anime as special genre (Animation + Japan)
		self.list.append({'name': 'Anime', 'url': 'with_genres=16&with_origin_country=JP&without_genres=99,10762,10767,10766&sort_by=vote_count.desc', 'image': 'genres.png', 'action': 'listings'})
